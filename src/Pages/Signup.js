        ...
        loading ? (
          ...
          <div className="h-max">
            <div className="flex flex-col  flex-wrap justify-center items-center md:flex-row w-full h-full">
              <div className=" w-[70%]">
                <div className="text-xl cursor-pointer flex flex-col justify-center items-center mt-5 md:mt-0 py-4">
                  ...
                  <div className="text-lg lg:text-xl text-center space-x-5 m-2 flex">
                    <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-full flex justify-center items-center ease-in duration-500 bg-slate-200  hover:bg-cyan-100 shadow-gray-900">
                      <a href="text">
              ...
              <div className="  lg:h-[100vh] lg:w-[30%]  bg-gradient-to-l from-blue-400 to-emerald-400  items-center flex justify-center md:w-[80%] sm:w-[80%]">
